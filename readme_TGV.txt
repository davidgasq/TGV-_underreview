...
If used for any publication, please cite : ToulGaitViz - A tool for the systematic description of lower limb clearance during the swing phase of hemiparetic gait after stroke. A cohort study., Montané E, Cormier C, Scandella M, Cangelosi A, Marque P, Moissenet F, Gasq D. Published in European Journal of Physical and Rehabilitation Medicine, 2023.
...
2. Download and run the ToulGaitViz.exe Installer. Then, let you guide by the wizard. You need to specify the path of the installation folder and the path of the v96 MATLAB Runtime folder previously installed. The application is located in installation folder/application folder.
...
- All subject information, dates and context of the 3DGA are required to continue
